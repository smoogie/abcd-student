    ...
    stages {
        ...
        stage('[ZAP] Baseline passive-scan') {
            ...
            post {
                always {
                    sh '''
                        docker cp zap:/zap/zreports/zap_html_report.html ${WORKSPACE}/zap_html_report.html
                        docker cp zap:/zap/zreports/zap_xml_report.xml ${WORKSPACE}/zap_xml_report.xml
